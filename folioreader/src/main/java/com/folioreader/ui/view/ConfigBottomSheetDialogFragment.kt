...
import com.folioreader.databinding.ViewConfigBinding // Added ViewBinding import
...
// Removed: import kotlinx.android.synthetic.main.view_config.*
...
class ConfigBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        // Consider if the global layout listener needs to be removed from binding.root.viewTreeObserver
        _binding = null
    }
